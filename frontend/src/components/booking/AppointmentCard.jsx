      ...
      <div className="card-body py-2 px-3">
        ...
        <div className="flex items-center justify-between mt-3">
          ...
          {appointment.status === "BOOKED" && isCounsellor && (
            <button
              className="btn btn-sm btn-xs bg-green-600 hover:bg-green-700 text-white border-none px-4 py-1 rounded-md shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 text-lg"
          ...
          {appointment.status === "BOOKED" && !isCounsellor && (
            <button
              className="btn btn-sm btn-xs bg-red-600 hover:bg-red-700 text-white border-none px-4 py-1 rounded-md shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 text-xs"
              onClick={() => onMarkComplete(appointment.appointmentId)}
            >
              Cancel
            </button>
