  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100 p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        {/* Header */}
        <h1 className="text-4xl md:text-5xl font-bold text-gray-800 text-center flex items-center justify-center gap-3">
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                ...
                <div className="flex-shrink-0">
                  <img 
                    ...
                    className="w-28 h-28 rounded-full border-4 border-white/40 object-cover shadow-lg"
                  />
                </div>

                {/* Info Section */}
                <div className="flex-1">
                  <h2 className="text-3xl font-bold mb-1">{counsellorInfo.name || "Counsellor"}</h2>
